Boat.create([{name: "Wayfarer", containers: "3", location: "NYC"}])
Boat.create([{name: "Honolulu Sunset", containers: "5", location: "Miami"}])
Boat.create([{name: "Wayfarer", containers: "10", location: "LA"}])
